<template>
  <div class="salesTable">
    <el-table :data="tableData"
              ...
              size="mini"
              style="width: 100%">
      <el-table-column  class-name="salesUsername"
                        prop="username"
                        label="USERNAME"
                        width="150">
      ...
      <el-table-column class-name="salesPrice"
                       prop="price"
                       label="PRICE"
                       width="80">
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.status === 4" class="likeColor">$ {{scope.row.price}}</span>
        </template>
      </el-table-column>
...
<script>
  import saleData from "@/assets/datas/sale.json";
  import userImg from "@/assets/img/avatar-3.png";
  export default {
    data() {
      return {
        tableData: saleData.data,
        userImg: userImg
      }
    }
  }
